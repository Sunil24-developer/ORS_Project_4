	...
	<div align="center">
		...
		<form action="<%=ORSView.STUDENT_LIST_CTL%>" method="post">
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>First Name :</b></label> <%=HTMLUtility.getList("firstName", String.valueOf(bean.getId()), studentlist)%>&emsp;												<label><b>Last Name :</b></label> <input type="text"
