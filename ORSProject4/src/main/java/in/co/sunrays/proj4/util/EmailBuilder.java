...
public class EmailBuilder {
	...
	public static String getUserRegistrationMessage(HashMap<String, String> map) {
		...
		msg.append("Registration is successful for ORS Project shreyash");
		msg.append("<H1>Hi! Greetings from shreyash!</H1>");
		msg.append(
		...
		msg.append("<p>For any assistance, please feel free to call us at +91 8435550304 helpline number.</p>");
		msg.append("<p>You may also write to us at sharma.shreyash123@gmail.com</p>");
		msg.append(
